...
### Available Servers
- **Sequential Thinking**: For architectural analysis and decision-making
- **Context7**: For technology research and documentation
- **GitHub**: For code review and repository operations
